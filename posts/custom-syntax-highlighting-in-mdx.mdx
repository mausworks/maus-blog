...
This blog is built on NextJS (and TypeScript—because I am not insane),
...
without me ever having to leave my IDE.
A quick look at some type definitions will tell me more about the library than
I would learn from reading minutes of documentation.
...
> **Tip:** If you have not yet graduated TypeSchool, the first less you should learn is that the most vital
> information in these messages are usually within the last few lines, even so in this case:
>
> ```txt
> Property 'children' is missing in type 'Node<Data>' but required in type 'Root'.ts(2322)
> ```
...
This is of course a different issue— but still an issue, fixing the import is of course dead simple:
