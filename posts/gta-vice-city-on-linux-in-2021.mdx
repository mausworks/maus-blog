...
**Grant Theft Auto - Vice City** came out in October of 2002:
...
Back in the olden days of 2002, Vice City was released for both Xbox & PlayStation&nbsp;2,
and while it also had a release for both Windows&nbsp;&&nbsp;MacOS,
...
We're not going to let this stop us though,
because while the game is now almost old enough to both legally drink and drive
(hopefully not at the same time), it has not been forgotten by its passionate modding community!

Before I get into the details of how to get this old nugget to run on your machine,
I just want to point out how ridiculous all of this is&mdash;
just as a recap if you haven't stopped to consider this yourself yet.
...
> in a resolution and aspect ratio that was _ridiculous at the time._ &hellip;
>
> _&hellip; and it will be absolutely glorious!_

Rest assured: The game is going to run on your hardware, just as God intended.
There are no emulators or other cheap tricks involved  
&mdash; _it just works!_
...
Now (like with the other controllers), completely disable controller support for the game in Steam.
