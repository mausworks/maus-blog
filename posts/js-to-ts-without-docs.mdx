...
<Poll
  ...
  correctResponse="Yes! But why would you pick this option?"
  options={{
...
and it has some very good use-cases&mdash;_but I do not think that this is one of them!_
...
The only thing that remains now is figuring out the signature of the `visitor` function.
